...
\begin{longtable}{|p{.2\textwidth}|p{.3\textwidth}|p{.4\textwidth}|}
	...
	binus & Jl. Ciumbuleuit No. 163, Ciumbuleuit, Cidadap, Kota Bandung, Jawa Barat 40141 (-6.87392, 107.60456) & \begin{minipage}{.4\textwidth}
		\vspace{5pt} \includegraphics[width=\textwidth, angle=90]{binus_1.jpg}
	\end{minipage} \\
	\hline
	...
	oxy & Jl. Ciumbuleuit No. 163, Ciumbuleuit, Cidadap, Kota Bandung, Jawa Barat 40141 (-6.87389, 107.60448) & \begin{minipage}{.4\textwidth}
		\vspace{5pt} \includegraphics[width=\textwidth, angle=90]{oxy_1.jpg}
	\end{minipage} \\
	\hline
	ping & Jl. Bukit Indah I No. 6, Ciumbuleuit, Cidadap, Kota Bandung, Jawa Barat 40141 (-6.87406, 107.60375) & \begin{minipage}{.4\textwidth}
		\vspace{5pt} \includegraphics[width=\textwidth, angle=90]{ping_1.jpg}
	\end{minipage} \\
	\hline
...
%		\hline
%	\end{tabular}
%	\caption{Beberapa contoh hasil BSIS pada Dataset 400 yang telah tersaring berdasarkan \texttt{uniqueness} dan \texttt{consistency}.}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.8\textwidth]{perbandingan_dataset400.png}
...
%		\hline
%	\end{tabular}
%	\caption{Beberapa contoh hasil BSIS pada Dataset 600 yang telah tersaring berdasarkan \texttt{uniqueness} dan \texttt{consistency}.}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.8\textwidth]{perbandingan_dataset600.png}
...
%
%Dataset yang digunakan pada analisis ini sama seperti analisis sebelumnya yaitu menggunakan \textit{dataset} Book Covers tetapi hanya menggunakan satu ukuran yaitu Dataset 400. Dataset 400 digunakan pada penelitian ini karena dari hasil sebelumnya didapat bahwa Dataset ini memberikan hasil yang terbaik.
%
...
%	Memuat \textit{dataset} yang digunakan (Dataset 400) dan saring data tersebut berdasarkan batas nilai keunikan serta konsistensi yang digunakan pada tahap ini. Dihitung juga jumlah data yang tersaring.
