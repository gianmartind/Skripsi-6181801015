...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{img\_matches2.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.8\textwidth]{objek_konsisten.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.7\textwidth]{ping_1247.jpg}	
...
Dari Gambar~\ref{fig:keypoint_konsisten} terutama pada gambar sebelah kiri terlihat bahwa sebagian besar \textit{keypoint} berasal dari bagian pagar dari POI tersebut. Bagian pagar merupakan bagian yang konsisten muncul di gambar-gambar POI tersebut. Dari hasil ini didapati bahwa dengan menggunakan \textit{clustering} dapat diperoleh \textit{keypoint} yang sifatnya konsisten, walaupun masih banyak juga \textit{keypoint} yang asalnya dari bagian tidak konsisten yang dari hasil analisis memiliki konsistensi tinggi.
...
\begin{enumerate}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=.65\textwidth]{contoh_gambar_clustering.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.24\textwidth]{004.jpg}
	\includegraphics[width=0.24\textwidth]{013.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.24\textwidth]{004-test1.jpg}
	\includegraphics[width=0.24\textwidth]{013-test1.jpg}
