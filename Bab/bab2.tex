...
\begin{figure}[H]
	\begin{subfigure}[b]{.5\textwidth}
		\centering
		\includegraphics[width=0.6\linewidth]{geo_ver1.png}
		\caption{}
		\label{subfig:geo_ver1}
	\end{subfigure}%
	\begin{subfigure}[b]{.5\textwidth}
		\centering
		\includegraphics[width=0.6\linewidth]{geo_ver2.png}
		\caption{}
...
\subsection{Pembuatan Descriptor}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.4\textwidth]{jarak_hamming.png}
...
Fungsi tersebut menghasilkan \textit{tuple} berisi objek \textit{keypoint} dan array vektor \textit{descriptor} untuk tiap objek \textit{keypoint}. Setiap vektor merupakan vektor berisi bilangan biner berjumlah 256 elemen. Objek \textit{keypoint} memiliki atribut sebagai berikut:
\begin{itemize}
	\item \textbf{pt}: atribut ini memiliki dua buah atribut \textbf{x} dan \textbf{y} yang menunjukkan koordinat dari \textit{keypoint}.
	\item \textbf{size}: diameter daerah di sekitar \textit{keypoint} yang diperiksa.
	\item \textbf{angle}: orientasi dari \textit{keypoint}.
...
\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{lsh_banding_bucket.png}
...
%LSH akan membandingkan sebuah vektor \textit{query} dengan vektor-vektor lain di \textit{dataset} dan menghitung jumlah \textit{band} yang sama untuk tiap vektor (\textit{collision}). Vektor-vektor tersebut kemudian akan dimasukkan ke dalam \textit{hash table} sesuai dengan \textit{band} di mana terjadi \textit{collision}. Dengan menggunakan \textit{hash table} tersebut LSH dapat membatasi jumlah vektor yang perlu diperiksa jaraknya dengan mengambil vektor yang muncul dalam beberapa \textit{hash table} saja. Contoh penggunaan teknik \textit{banding} LSH untuk mencari tetangga terdekat dari sebuah vektor dapat dilihat pada Gambar~\ref{fig:lsh_band}.
%
%\begin{figure}[H]
%	\centering
%	\includegraphics[width=\textwidth]{lsh_band.png}
%	\caption{Ilustrasi teknik \textit{banding} dalam mencari tetangga terdekat dari suatu vektor.}
%	\label{fig:lsh_band}
%\end{figure}
%
%Gambar~\ref{fig:lsh_band} menunjukkan sebuah vektor biner $query$ yang ingin dicari tetangga terdekatnya dari 4 vektor $A$, $B$, $C$, dan $D$ yang juga merupakan vektor biner. Vektor-vektor tersebut dibagi menjadi \textit{band} dengan ukuran 4, di mana setiap vektor akan dibagi menjadi vektor-vektor kecil berukuran 4 bit. Empat buah kotak merupakan \textit{hash table} yang masing-masing memiliki fungsi \textit{hash} berbeda. Kotak pertama (kotak paling kiri) membandingkan nilai dari \textit{band} pertama, vektor yang nilai \textit{band} pertamanya sama dengan vektor $query$ akan dimasukkan ke dalam kotak tersebut. Kotak kedua merupakan \textit{hash table} yang membandingkan nilai dari \textit{band} kedua, kotak ketiga membandingkan \textit{band} ketiga dan seterusnya. 
%
%Kemunculan sebuah vektor di \textit{hash table} menunjukkan bahwa ada bagian yang mirip antara vektor tersebut dengan vektor $query$. Semakin banyak \textit{hash table} di mana sebuah vektor muncul maka akan semakin tinggi kemungkinan vektor tersebut untuk menjadi pasangan yang paling mirip $query$. Sebaliknya jika ada vektor yang tidak muncul sama sekali dalam \textit{hash table} maka kecil kemungkinan vektor tersebut untuk menjadi pasangan yang mirip. Dengan menggunakan cara ini pencarian tetangga terdekat dapat dipercepat dengan membuang kandidat-kandidat yang memiliki kemungkinan kecil untuk menjadi pasangan mirip.
...
\section{Dataset Stanford Mobile Visual Search}
...
\begin{longtable}{|p{.2\textwidth}|p{.39\textwidth}|p{.39\textwidth}|}
	...
	\texttt{book\_covers} & \begin{minipage}{.39\textwidth}
		\vspace{5pt} \includegraphics[width=\textwidth]{book_covers_001.jpg} 
	\end{minipage} & \begin{minipage}{.39\textwidth}
		\vspace{5pt} \includegraphics[width=\textwidth]{book_covers_ref.jpg}
	\end{minipage} \\
	\hline
	\texttt{business\_cards} & \begin{minipage}{.39\textwidth}
		\vspace{5pt} \includegraphics[width=\textwidth]{business_cards_001.jpg} 
	\end{minipage} & \begin{minipage}{.39\textwidth}
		\vspace{5pt} \includegraphics[width=\textwidth]{business_cards_ref.jpg}
	\end{minipage} \\
	\hline
	\texttt{cd\_covers} & \begin{minipage}{.39\textwidth}
		\vspace{5pt} \includegraphics[width=\textwidth]{cd_covers_001.jpg} 
	\end{minipage} & \begin{minipage}{.39\textwidth}
		\vspace{5pt} \includegraphics[width=\textwidth]{cd_covers_ref.jpg}
	\end{minipage} \\
	\hline
	\texttt{dvd\_covers} & \begin{minipage}{.39\textwidth}
		\vspace{5pt} \includegraphics[width=\textwidth]{dvd_covers_001.jpg} 
	\end{minipage} & \begin{minipage}{.39\textwidth}
		\vspace{5pt} \includegraphics[width=\textwidth]{dvd_covers_ref.jpg}
	\end{minipage} \\
	\hline
	\texttt{landmarks} & \begin{minipage}{.39\textwidth}
		\vspace{5pt} \includegraphics[width=\textwidth]{landmarks_001.jpg} 
	\end{minipage} & \begin{minipage}{.39\textwidth}
		\vspace{5pt} \includegraphics[width=\textwidth]{landmarks_ref.jpg}
	\end{minipage} \\
	\hline
	\texttt{museum\_paintings} & \begin{minipage}{.39\textwidth}
		\vspace{5pt} \includegraphics[width=\textwidth]{museum_paintings_001.jpg} 
	\end{minipage} & \begin{minipage}{.39\textwidth}
		\vspace{5pt} \includegraphics[width=\textwidth]{museum_paintings_ref.jpg}
	\end{minipage} \\
	\hline
	\texttt{print} & \begin{minipage}{.39\textwidth}
		\vspace{5pt} \includegraphics[width=\textwidth]{print_001.jpg} 
	\end{minipage} & \begin{minipage}{.39\textwidth}
		\vspace{5pt} \includegraphics[width=\textwidth]{print_ref.jpg}
	\end{minipage} \\
	\hline
	\texttt{video\_frames} & \begin{minipage}{.39\textwidth}
		\vspace{5pt} \includegraphics[width=\textwidth]{video_frames_001.jpg} 
	\end{minipage} & \begin{minipage}{.39\textwidth}
		\vspace{5pt} \includegraphics[width=\textwidth]{video_frames_ref.jpg}
	\end{minipage} \\
	\hline
\end{longtable}